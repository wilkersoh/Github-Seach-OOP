...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\nfunction _classCallCheck(instance, Constructor) { if (!(instance instanceof Constructor)) { throw new TypeError(\"Cannot call a class as a function\"); } }\n\nfunction _defineProperties(target, props) { for (var i = 0; i < props.length; i++) { var descriptor = props[i]; descriptor.enumerable = descriptor.enumerable || false; descriptor.configurable = true; if (\"value\" in descriptor) descriptor.writable = true; Object.defineProperty(target, descriptor.key, descriptor); } }\n\nfunction _createClass(Constructor, protoProps, staticProps) { if (protoProps) _defineProperties(Constructor.prototype, protoProps); if (staticProps) _defineProperties(Constructor, staticProps); return Constructor; }\n\nvar UI =\n/*#__PURE__*/\nfunction () {\n  function UI() {\n    _classCallCheck(this, UI);\n\n    this.profile = document.getElementById('profile');\n  }\n\n  _createClass(UI, [{\n    key: \"showProfile\",\n    value: function showProfile(user) {\n      this.profile.innerHTML = \"\\n            <div class=\\\"user-container\\\">\\n                <div class=\\\"row\\\">\\n                    <div class=\\\"user-profile\\\">\\n                        <img src=\\\"\".concat(user.avatar_url, \"\\\">\\n                        <p>\").concat(user.bio, \"</p>\\n                        <p>\").concat(user.company, \"</p>\\n                        <p>Location: \").concat(user.location, \"</p>\\n                        <p>Posted: \").concat(user.public_repos, \"</p>\\n                        <p>Member Since: \").concat(user.created_at, \"</p>\\n                        <a href=\\\"\").concat(user.html_url, \"\\\" target=\\\"_blank\\\">View Profile</a>\\n                    </div>\\n                </div>\\n            </div>\\n\\n        \");\n    } // show the repos\n\n  }, {\n    key: \"showRepos\",\n    value: function showRepos(repos) {\n      var output = '';\n      repos.forEach(function (repo) {\n        output += \"\\n                <div>\\n                    <div class=\\\"row\\\">\\n                    <div>\\n                        <a href=\\\"\\\" target=\\\"_blank\\\">\".concat(repo.name, \"</a>\\n                    </div>\\n                    <div>\\n                        \\n                    </div>\\n                    </div>\\n                </div>\\n            \");\n      }); // REnder DOM\n\n      document.getElementById('repos').innerHTML = output;\n    }\n  }, {\n    key: \"showAlert\",\n    value: function showAlert(message, className) {\n      var _this = this;\n\n      this.clearAlert(); // create DOM\n\n      var div = document.createElement('div');\n      div.className = className;\n      div.appendChild(document.createTextNode(message)); // parent\n\n      var container = document.querySelector('.container');\n      var beforeProfile = document.querySelector('#profile'); // container里面 search之前 插入\n\n      container.insertBefore(div, beforeProfile); // clear Alert after 3s\n\n      setTimeout(function () {\n        _this.clearAlert();\n      }, 3000);\n    }\n  }, {\n    key: \"clearAlert\",\n    value: function clearAlert() {\n      var currentAlert = document.querySelector('.alert');\n\n      if (currentAlert) {\n        currentAlert.remove();\n      }\n    }\n  }, {\n    key: \"clearProfile\",\n    value: function clearProfile() {\n      this.profile.innerHTML = '';\n    }\n  }]);\n\n  return UI;\n}();\n\n/* harmony default export */ __webpack_exports__[\"default\"] = (UI);\n\n//# sourceURL=webpack:///./src/js/ui.js?");
